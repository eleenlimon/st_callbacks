...
with col1:
    miles = st.number_input('Miles:', key='miles', on_change=miles_to_km)  # be able to return one or the other if different input from user
